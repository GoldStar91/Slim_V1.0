...
define( 'DB_NAME', 'slim' );  // set database name
define( 'SEND_ERRORS_TO', 'yangwesong@yahoo.com' ); //set email notification email address
...
class DB
{
     ...
     * $data = array( 'name' => $_POST['name'], 'email' => 'yangwesong@yahoo.com' );
     ...
     * Example Usage:
     * $check_user = array(
     *    'user_email' => 'yangwesong@yahoo.com', 
     *    'user_id' => 48
     * );
    ...
    */
     ...
     *  $records = array(
     *     array(
     *          'World Star', 'yangwesong2@yahoo.com', 1
     *      ), 
     *      array(
     *          'World Star', 'yangwesong1@yahoo.com', 0
     *      ), 
     *      array(
     *          'World Star', 'yangwesong@yahoo.com', 1, 'This will not be added'
     *      ), 
     *      array(
     *          'World Star', 'yangwesong@yahoo.com', 1
     *      )
     * );
     ...
     *
     * Example usage:
     * $update = array( 'name' => 'World Star', 'email' => 'yangwesong@yahoo.com' );
